...
--* Filename: 5374_task_4.lua
--* Theme: Hungry Bird
--* Functions: sysCall_init, initiatepath, visualizePath, getpose, packdata, compute_and_send_path, sysCall_actuation, sysCall_sensing, sysCall_cleanup, aruco_callback, whycon_callback, key_callback
--* Classes: Edrone
