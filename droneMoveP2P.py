...
class Edrone():
	...
	def __init__(self):
		...
		self.initial_waypoint = [0,0,20,0.00] # whycon marker at the position of the initial waypoint in the scene (blue sphere). These are whycon coordinates of the same
